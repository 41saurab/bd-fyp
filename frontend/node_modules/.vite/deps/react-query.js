...
function parseMutationFilterArgs(arg1, arg2) {
	return isQueryKey(arg1) ? _extends({}, arg2, { mutationKey: arg1 }) : arg1;
}
...
var focusManager = new (/* @__PURE__ */ function(_Subscribable) {
...
var onlineManager = new (/* @__PURE__ */ function(_Subscribable) {
...
var notifyManager = new (/* @__PURE__ */ function() {
...
//#endregion
//#region node_modules/react-query/es/core/queriesObserver.js
var QueriesObserver = /*#__PURE__*/ function(_Subscribable) {
	...
	function QueriesObserver(client, queries) {
		...
		_this.observers = [];
		_this.observersMap = {};
		if (queries) _this.setQueries(queries);
		return _this;
	}
	var _proto = QueriesObserver.prototype;
	_proto.onSubscribe = function onSubscribe() {
		var _this2 = this;
		if (this.listeners.length === 1) this.observers.forEach(function(observer) {
	...
	_proto.findMatchingObservers = function findMatchingObservers(queries) {
		...
		return matchingObservers.concat(newOrReusedObservers).sort(function sortMatchesByOrderOfQueries(a, b) {
...
//#endregion
//#region node_modules/react-query/es/core/infiniteQueryObserver.js
var InfiniteQueryObserver = /*#__PURE__*/ function(_QueryObserver) {
	...
	_proto.setOptions = function setOptions(options, notifyOptions) {
		_QueryObserver.prototype.setOptions.call(this, _extends({}, options, { behavior: infiniteQueryBehavior() }), notifyOptions);
	};
	_proto.getOptimisticResult = function getOptimisticResult(options) {
	...
	_proto.createResult = function createResult(query, options) {
		...
		var state = query.state;
		return _extends({}, _QueryObserver.prototype.createResult.call(this, query, options), {
...
//#endregion
//#region node_modules/react-query/es/core/hydration.js
...
function hydrate(client, dehydratedState, options) {
	...
	mutations.forEach(function(dehydratedMutation) {
		...
		mutationCache.build(client, _extends({}, options == null ? void 0 : (_options$defaultOptio = options.defaultOptions) == null ? void 0 : _options$defaultOptio.mutations, { mutationKey: dehydratedMutation.mutationKey }), dehydratedMutation.state);
	});
...
var unstable_batchedUpdates = import_react_dom.unstable_batchedUpdates;
//#endregion
...
var useQueryClient = function useQueryClient() {
	var queryClient = import_react.useContext(getQueryClientContext(import_react.useContext(QueryClientSharingContext)));
...
var QueryClientProvider = function QueryClientProvider(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement(QueryClientSharingContext.Provider, { value: contextSharing }, /*#__PURE__*/ import_react.createElement(Context.Provider, { value: client }, children));
};
//#endregion
...
var useQueryErrorResetBoundary = function useQueryErrorResetBoundary() {
	return import_react.useContext(QueryErrorResetBoundaryContext);
};
var QueryErrorResetBoundary = function QueryErrorResetBoundary(_ref) {
	var children = _ref.children;
	var value = import_react.useMemo(function() {
		return createValue();
	}, []);
...
//#endregion
//#region node_modules/react-query/es/react/useIsFetching.js
var checkIsFetching = function checkIsFetching(queryClient, filters, isFetching, setIsFetching) {
	...
	if (isFetching !== newIsFetching) setIsFetching(newIsFetching);
};
function useIsFetching(arg1, arg2) {
	var mountedRef = import_react.useRef(false);
	var queryClient = useQueryClient();
	var filters = parseFilterArgs(arg1, arg2)[0];
	var _React$useState = import_react.useState(queryClient.isFetching(filters)), isFetching = _React$useState[0], setIsFetching = _React$useState[1];
	var filtersRef = import_react.useRef(filters);
	filtersRef.current = filters;
	var isFetchingRef = import_react.useRef(isFetching);
	...
	import_react.useEffect(function() {
		...
		var unsubscribe = queryClient.getQueryCache().subscribe(notifyManager.batchCalls(function() {
			if (mountedRef.current) checkIsFetching(queryClient, filtersRef.current, isFetchingRef.current, setIsFetching);
		}));
		return function() {
...
//#endregion
//#region node_modules/react-query/es/react/useIsMutating.js
function useIsMutating(arg1, arg2) {
	var mountedRef = import_react.useRef(false);
	var filters = parseMutationFilterArgs(arg1, arg2);
	var queryClient = useQueryClient();
	var _React$useState = import_react.useState(queryClient.isMutating(filters)), isMutating = _React$useState[0], setIsMutating = _React$useState[1];
	var filtersRef = import_react.useRef(filters);
	filtersRef.current = filters;
	var isMutatingRef = import_react.useRef(isMutating);
	...
	import_react.useEffect(function() {
		...
		var unsubscribe = queryClient.getMutationCache().subscribe(notifyManager.batchCalls(function() {
			if (mountedRef.current) {
				...
				if (isMutatingRef.current !== newIsMutating) setIsMutating(newIsMutating);
			}
		}));
		return function() {
			mountedRef.current = false;
...
function useMutation(arg1, arg2, arg3) {
	var mountedRef = import_react.useRef(false);
	var forceUpdate = import_react.useState(0)[1];
	var options = parseMutationArgs(arg1, arg2, arg3);
	var queryClient = useQueryClient();
	var obsRef = import_react.useRef();
	...
	var mutate = import_react.useCallback(function(variables, mutateOptions) {
...
function useBaseQuery(options, Observer) {
	...
	var observer = import_react.useState(function() {
...
//#endregion
//#region node_modules/react-query/es/react/useQueries.js
function useQueries(queries) {
	var mountedRef = import_react.useRef(false);
	var forceUpdate = import_react.useState(0)[1];
	var queryClient = useQueryClient();
	var defaultedQueries = (0, import_react.useMemo)(function() {
...
//#endregion
//#region node_modules/react-query/es/react/useInfiniteQuery.js
function useInfiniteQuery(arg1, arg2, arg3) {
	return useBaseQuery(parseQueryArgs(arg1, arg2, arg3), InfiniteQueryObserver);
}
//#endregion
//#region node_modules/react-query/es/react/Hydrate.js
function useHydrate(state, options) {
	var queryClient = useQueryClient();
	var optionsRef = import_react.useRef(options);
