...
import OrgCampaignDetail from './pages/organization/CampaignDetail';
import OrgEmergency from './pages/organization/Emergency';
import OrgEmergencyDetail from './pages/organization/EmergencyDetail';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <Routes>
          ...
          <Route path="/organization/campaigns/:id/edit" element={<ProtectedRoute role="organization"><CreateCampaign /></ProtectedRoute>} />
          <Route path="/organization/campaigns/:id" element={<ProtectedRoute role="organization"><OrgCampaignDetail /></ProtectedRoute>} />
          ...
          <Route path="/organization/emergency/:id/edit" element={<ProtectedRoute role="organization"><CreateEmergency /></ProtectedRoute>} />
          <Route path="/organization/emergency/:id" element={<ProtectedRoute role="organization"><OrgEmergencyDetail /></ProtectedRoute>} />
