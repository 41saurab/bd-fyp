...
export const emergencyCancelledEmailTemplate = ({ name, orgName, bloodType, patientName, city }) => {
	const subject = `Emergency Request Cancelled - ${bloodType} in ${city}`;
	...
	<head>
		<meta charset="UTF-8" />
		<title>Emergency Cancelled</title>
	</head>
			...
			<tr>
				<td align="center" style="padding:40px 20px;">
					...
					<table width="600" style="background:#ffffff;border-radius:12px;overflow:hidden;">
						...
						<tr>
							<td style="background:#78716c;padding:30px;text-align:center;color:#fff;">
								<h1 style="margin:0;">🚫 Emergency Cancelled</h1>
							</td>
						</tr>
						...
						<tr>
							<td style="padding:30px;">
								...
								<p style="color:#4b5563;line-height:1.6;">
									The emergency blood request you responded to has been
									cancelled by ${orgName}.
								</p>
								...
								<p style="color:#4b5563;">
									Thank you for your willingness to help — you'll still be
									notified the next time a matching request comes in.
								</p>
							</td>
						</tr>
...
export const campaignCancelledEmailTemplate = ({ name, orgName, campaignTitle, city, venue }) => {
	const subject = `Campaign Cancelled - ${campaignTitle}`;
			...
			<tr>
				<td align="center" style="padding:40px 20px;">
					...
					<table width="600" style="background:#ffffff;border-radius:12px;overflow:hidden;">
						...
						<tr>
							<td style="background:#78716c;padding:30px;text-align:center;color:#fff;">
								<h1 style="margin:0;">🚫 Campaign Cancelled</h1>
							</td>
						</tr>
						...
						<tr>
							<td style="padding:30px;">
								...
								<p style="color:#4b5563;line-height:1.6;">
									${orgName} has cancelled the blood donation campaign you
									registered for.
								</p>
								...
								<p style="color:#4b5563;">
									We're sorry for the inconvenience. Keep an eye on your
									dashboard for other campaigns near you.
								</p>
							</td>
						</tr>
