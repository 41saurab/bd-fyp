	...
	return (
		<div className="max-w-5xl mx-auto px-6 py-16">
			<div className="text-center mb-16">
				<h1 className="text-4xl font-display font-bold text-stone-800 mb-4">How Raktabindu Works</h1>
			...
			<div className="text-center">
				<Link to="/register/donor" className="btn-primary text-base px-10 py-3">
